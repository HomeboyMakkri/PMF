...
QT_MOC_LITERAL(1, 17, 15), // "newDataReceived"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 9), // "frequency"
QT_MOC_LITERAL(4, 44, 13), // "errorOccurred"
QT_MOC_LITERAL(5, 58, 5), // "error"
QT_MOC_LITERAL(6, 64, 12), // "disconnected"
QT_MOC_LITERAL(7, 77, 15) // "handleReadyRead"

    },
    "SerialPortReader\0newDataReceived\0\0"
    "frequency\0errorOccurred\0error\0"
    "disconnected\0handleReadyRead"
};
...
void SerialPortReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newDataReceived((*reinterpret_cast< double(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SerialPortReader::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortReader::newDataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortReader::errorOccurred)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SerialPortReader::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortReader::disconnected)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SerialPortReader::newDataReceived(double _t1)
{
...
// SIGNAL 1
void SerialPortReader::errorOccurred(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void SerialPortReader::disconnected()
{
